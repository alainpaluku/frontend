...
import { SectionCourses } from "@/pages/section/SectionCourses";
import { SectionSchedules } from "@/pages/section/SectionSchedules";
  ...
  return (
    <Routes>
      ...
      >
        ...
        {/* Section / Pédagogie */}
        <Route element={<RoleGuard allow="section" />}>
          <Route path="/section/dashboard" element={<SectionDashboard />} />
          <Route path="/section/courses" element={<SectionCourses />} />
          <Route path="/section/schedules" element={<SectionSchedules />} />
        </Route>
