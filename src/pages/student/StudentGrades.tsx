...
import { appealApi } from "@/api/endpoints/academic"
...
export function StudentGrades() {
  ...
  const { refetch: refetchAppeals } = useAppeals()
  ...
  async function handleAppeal() {
    ...
    try {
      ...
      toast.success("Votre recours a été soumis avec succès.")
      await refetchAppeals()
      setAppealGrade(null)
      setReason("")
      setEstimatedGrade("")
    } catch (err: any) {
      toast.error(err?.message || "Impossible de soumettre le recours.")
    } finally {
